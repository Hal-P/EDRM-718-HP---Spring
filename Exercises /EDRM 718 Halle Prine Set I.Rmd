...
# (b) Incorrect use: Non-numeric vector
print(cool_mean(c("a", "b", "c"), 2))    # Should print an error message

# (c) Incorrect use: Negative scalar
print(cool_mean(random_numbers, -1))     # Should print an error message
...
ordered_summary <- function(x) {
  # Compute the five-number summary and mean
  summary_stats <- c(summary(x), mean = mean(x))
  
  # Sort the values in ascending order
  return(sort(summary_stats))
}
